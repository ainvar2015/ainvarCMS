...
$base_url = 'http://localhost/Volcano/';
/*	// Get HTTP/HTTPS
...
$upload_dir = '/filemanager/myuploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = 'myuploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = 'myuploads/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
