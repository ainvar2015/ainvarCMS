...
<html lang="es">
	<head>
		...
		<!-- Bootstrap Calendar stylesheet -->
		<link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/css/calendar.css">
		<!-- Bootstrap toggle -->
		...
		<script src="<?php echo base_url() ?>assets/admin/js/locales/bootstrap-datetimepicker.es.js"></script>
		<script src="<?php echo base_url() ?>assets/js/language/es-ES.js"></script>
